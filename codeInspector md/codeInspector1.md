...
5. The first file is the file that is used to star the app.
...
<body class="bg-[#181825] text-[#cdd6f4] h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-sm font-bold tracking-wider text-white uppercase flex items-center gap-2">
          The Code Inspector Pro <span class="text-[9px] bg-[#f9e2af] text-[#11111b] px-1 rounded">V3.1 Enterprise</span>
        </h1>
        <p class="text-[10px] text-[#a6adc8]">Advanced Complexity, Dead-Code, & Security Analyzer</p>
      </div>
    </div>
  ...
  <div class="flex flex-1 overflow-hidden">
    ...
    <!-- Right Sidebar: Interactive Diagnostic Dashboard -->
    <section class="w-80 bg-[#11111b] border-l border-[#313244] flex flex-col shrink-0">
      <div class="flex border-b border-[#313244] text-xs">
        <button id="tabDashboardBtn" class="flex-1 py-3 text-center border-b-2 border-[#cba6f7] font-semibold text-white">
          <i data-lucide="layout-dashboard" class="w-3.5 h-3.5 inline mr-1"></i> Dashboard
        </button>
        <button id="tabIssuesBtn" class="flex-1 py-3 text-center border-b-2 border-transparent text-[#a6adc8] hover:text-white font-semibold">
          <i data-lucide="shield-alert" class="w-3.5 h-3.5 inline mr-1"></i> Diagnostics
        </button>
        <button id="tabAstBtn" class="flex-1 py-3 text-center border-b-2 border-transparent text-[#a6adc8] hover:text-white font-semibold">
...
// Upgraded Interactive File Tree Rendering (with Delete, Rename, and Hover Controls)

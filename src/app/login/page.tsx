    ...
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 relative overflow-hidden font-mono text-blue-400">
      ...
      <div className="w-full max-w-md bg-black/60 border border-white/5 backdrop-blur-2xl p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] relative z-10">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-5 bg-blue-600/10 border border-blue-500/30 hover:bg-blue-600 hover:text-white text-blue-400 font-bold tracking-normal uppercase transition-all duration-500 flex items-center justify-center gap-3 group relative overflow-hidden rounded-lg px-4"
        >
          {loading ? (
